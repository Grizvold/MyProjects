...
int main(int  argc, char **argv)
{
	...
	*/
	...
	printf("%*c 0. To Exit and Stop\n", 5, ' ');
        ...
        switch(usr_input){
            case (1):
                StrLen(const char *string_num_1);
		StrLen(const char *string_num_2);
		printf("%*c    The lenght of str1 = %d and str2 = %d\n\n\n\n\n", 5, ' ',
								 StrLen(const char *string_num_1)
								, StrLen(const char *string_num_2));
                break;
            case (2):
                printf("%*c    The result of strcmp is %d\n", 5, ' ', StrCmp(const char *string_num_1, const char *string_num_2));
                break;
            case (3):
		string_num_1 = StrCpy(char *string_num_1, const char *string_num_2;
                printf("%*c    The result of strcpy is %s\n", 5, ' ', string_num_1);               
                break;
            case (4):
		string_num_1 = StrCat(char *string_num_1, const char *string_num_2);
